          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                Navigator.pop(context);
                await _addMealItem(meal.id, selectedFoodItem!.id, quantity);
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: AppConfig.blueColor,
                foregroundColor: AppConfig.whiteColor,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _buildNutritionValue('Protein', '${foodItem.proteinFor(grams)}g'),
              _buildNutritionValue('Carbs', '${foodItem.carbsFor(grams)}g'),
              _buildNutritionValue('Fat', '${foodItem.fatFor(grams)}g'),
            ],
          ),
        ],
      ),
